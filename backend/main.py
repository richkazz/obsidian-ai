...
# Enable OpenTelemetry instrumentation for MAF agent framework if explicitly configured
import os
if os.getenv("ENABLE_OTEL_INSTRUMENTATION", "false").lower() in ("true", "1", "yes"):
    try:
